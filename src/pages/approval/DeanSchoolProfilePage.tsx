...
import { User, Mail, Phone, Building2, GraduationCap, CreditCard } from 'lucide-react';

const DeanSchoolProfilePage = () => {
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Dean of School — Personal Information</p>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <InfoRow icon={<GraduationCap className="w-4 h-4 text-purple-500" />} label="Role" value={profile?.role || 'Dean of School'} />
...
export default DeanSchoolProfilePage;
